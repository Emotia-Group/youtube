...
- Se reencuadra a vertical **a sangre**: la imagen ocupa los cuatro bordes,
  ...
  cabe un tercio del ancho—, y ese es el precio correcto: el vídeo vertical
  ...
  decide si desliza. (El fondo desenfocado sigue estando en **Ajustes**, pero
  ya no es lo recomendado.)
- Como solo cabe un tercio del ancho, tú eliges **por dónde se recorta** —por
  la izquierda, por el centro o por la derecha—: en **Ajustes** para todas, y
  **Short a Short** en la pestaña Shorts. Míralo antes de generar: recortar
  siempre por el centro decapita cualquier plano cuyo sujeto no esté centrado.
...
encadenados en el orden que tú necesitas. En la ficha de la pieza los ves
escritos: `1:04 → 1:22  +  4:31 → 4:48`.
...
- **Cama musical continua** por debajo de la voz, sin un solo corte, y bajando
  sola cuando hablas. Es la medida que de verdad tapa el salto: la música
  seguida enmascara los cambios de la música vieja que viaja dentro de cada
  trozo. La pista sale de la **música del propio video largo** —para que quien
  salte del Short al largo se encuentre el mismo mundo sonoro—, o de
  `assets\music` si el largo no es un proyecto del programa. Y se elige
  **midiendo**, no de oído: la más plana de las que haya.

En **Ajustes** decides cuándo se pone la cama: solo cuando hay varios
fragmentos (lo que viene puesto), siempre, o nunca.
...
tu canal. Se llama `miniatura_1_prueba150px.png` y está en la carpeta `09_final`
del proyecto. **Ábrela y míralo ahí**: si a ese tamaño no lees el texto, la
miniatura no sirve, por bonita que sea a tamaño completo. A 150 px solo entran
una cara y tres o cuatro palabras — si te pasas, el programa te lo dice.
